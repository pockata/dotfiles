...
-- pastel collors from
-- https://github.com/abevince/dotfiles/blob/f7c1fc512ce97514747c7b3d0e62add2e937bf07/.Xresources
theme.border_normal = "#323232"
theme.border_focus  = "#6272a4"
theme.border_fullscreen = "#f07178"
theme.border_floating = "#C792EA"
-- theme.border_focus  = "#4c9882"
-- theme.border_fullscreen = "#87404f"
-- theme.border_floating = "#c0a79a"

-- theme.border_marked = "#91231c"

theme.hotkeys_font = font .. " 10"
theme.hotkeys_description_font = font .. " 9"
theme.hotkeys_modifiers_fg = xrdb.color9
