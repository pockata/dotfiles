...
nnoremap("gI", "<silent>", "<cmd>Telescope lsp_implementations<CR>")
-- nnoremap("gd", "<silent>", "<cmd>Telescope lsp_definitions<CR>")
nnoremap("gD", "<silent>", "<cmd>Telescope lsp_type_definitions<CR>")
nnoremap("<Leader>ew", "<silent>", "<cmd>Telescope lsp_dynamic_workspace_symbols<CR>")
